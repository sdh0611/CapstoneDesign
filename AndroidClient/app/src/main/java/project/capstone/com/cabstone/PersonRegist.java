...
public class PersonRegist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registBtn=(Button)findViewById(R.id.person_regist_OK);
        cancelBtn=(Button)findViewById(R.id.person_regist_Cancel);

        userIDText = (EditText)findViewById(R.id.person_regist_ID);
        userPWText = (EditText)findViewById(R.id.person_regist_PW);
        userNameText = (EditText)findViewById(R.id.person_regist_Name);
        userAgeText = (EditText)findViewById(R.id.person_regist_Age);
        userMailAddrText = (EditText)findViewById(R.id.person_regist_Email);
        ...
        registBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String pw = userPWText.getText().toString();
                String name = userNameText.getText().toString();
                String age = userAgeText.getText().toString();
                String mailAddr = userMailAddrText.getText().toString();

                Log.v("MyLog", "RegistJson");
                String json = "{" + "\"type\": \"registPersonal\"" + ", "+"\"userID\":" + id + ", "+ "\"userPW\":" + pw + ", "
                        + "\"userName\":" + name + ", " + "\"userAge\":" + age + ", " + "\"userMailAddr\":" + mailAddr + "}";

                new PersonRegist.JSONTask().execute(url, json);
                Log.v("MyLog", id);
                Log.v("MyLog", pw);
